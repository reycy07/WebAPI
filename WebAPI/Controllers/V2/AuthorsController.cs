...
namespace WebAPI.Controllers.V2
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post(AuthorCreateDTO authorCreateDTO)
        {
            ...
            return CreatedAtRoute("GetAuthorV2", new { id = author.Id}, author);
        }
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [OutputCache(Tags = [cache])]
        public async Task<ActionResult<AuthorWithBooksDTO>> Get([Description("Author ID")]int id, bool includeBooks = false)
            {
            var queryable = context.Authors.AsQueryable();
